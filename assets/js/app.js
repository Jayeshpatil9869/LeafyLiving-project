...
// Assuming you have an image with the class 'zoom-hover-image'
document.querySelectorAll('.zoom-hover-image').forEach(function(img) {
    ...
    // Apply CSS to the wrapper and image
    ...
    wrapper.addEventListener('mouseenter', function() {
      ...
      img.src = 'assets\img\gallery-bright-living.jpg'; // Change to the new image on hover
    });
  
    wrapper.addEventListener('mouseleave', function() {
      img.style.transform = 'scale(1)';
      img.src = 'https://kyari.co/cdn/shop/products/DSC05206copy.jpg?v=1675675600&width=360'; // Change back to the original image
    });
  });
